...
tocopy <- with(dat,sprintf(paste0('User: <strong>%s</strong>, # of Reviews: %i',
                         ...
                         '\n<a href="http://www.sputnikmusic.com/blog/wp-content/uploads/%s.png"><img class="aligncenter" src="http://www.sputnikmusic.com/blog/wp-content/uploads/%s.png" alt="%s" width="600" height="600" /></a>'),
